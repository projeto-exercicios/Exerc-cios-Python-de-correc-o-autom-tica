...
def make_transformations():
    ...
    change_token_all_occurrences('c',"<b><font color=green><i>" +  c+ "</font></i></b>")
    change_token_all_occurrences('d',"<b><font color=green><i>" +  d+ "</font></i></b>")
    change_token_all_occurrences('e',"<b><font color=green><i>" +  e+ "</font></i></b>")
    change_token_all_occurrences('f',"<b><font color=green><i>" +  f+ "</font></i></b>")
    ...
    change_all_occurrences('23',"<b><font color=green><i>" +  str(_23)+ "</font></i></b>")
    change_all_occurrences('33',"<b><font color=green><i>" +  str(_33)+ "</font></i></b>")
    change_all_occurrences('numpy_func',"<b><font color=green><i>" +  numpy_func+ "</font></i></b>")

    
    # answers
    change_all_occurrences(r'\verb+a+',"<b><font color=green><i>" +  r'\verb+' + a + '+'+ "</font></i></b>")
    change_all_occurrences(r'\verb+e+',"<b><font color=green><i>" +  r'\verb+' + e + '+'+ "</font></i></b>")
    ...
    _2 = randint(0,1)
    if _2 == 0:
        change_all_occurrences(r'\verb+2+',"<b><font color=green><i>" +  r'\verb+' + pt_E + '+'+ "</font></i></b>")
    if _2 == 1:
        change_all_occurrences(r'\verb+2+',"<b><font color=green><i>" +  r'\verb+' + pt_Nao + '+'+ "</font></i></b>")
    ...
    change_all_occurrences(r'\verb+3+',"<b><font color=green><i>" +  r'\verb+' + _3_funcs[_3_idx] + '+'+ "</font></i></b>")
    if _3_idx % 2 == 0:
        ...
        change_all_occurrences(r'\verb+33+',"<b><font color=green><i>" +  answer_3_true+ "</font></i></b>")
        change_all_occurrences(r'\verb+333+',"<b><font color=green><i>" +  answer_3_false+ "</font></i></b>")
    ...
    change_all_occurrences(r'\verb+5+',"<b><font color=green><i>" +  r'\verb+' + f + '[' + str(_5) + ']+'+ "</font></i></b>")

    # true answer
    _1_t, answer_1_true = quest_1(maneiras_corretas, maneiras_incorretas, True)
    change_all_occurrences(r'\verb+1_t+',"<b><font color=green><i>" +  r'\verb+' + _1_t + '+'+ "</font></i></b>")
    change_all_occurrences(r'\verb+11+',"<b><font color=green><i>" +  answer_1_true+ "</font></i></b>")
    # false answer
    _1_f, answer_1_false = quest_1(maneiras_corretas, maneiras_incorretas, False)
    change_all_occurrences(r'\verb+1_f+',"<b><font color=green><i>" +  r'\verb+' + _1_f + '+'+ "</font></i></b>")
    change_all_occurrences(r'\verb+111+',"<b><font color=green><i>" +  answer_1_false+ "</font></i></b>")
...
def make_transformations_on_results(program):
    ...
    answer_2_true = possible_shape(len(the_list)) if _2 == 0                    else possible_shape(len(the_list) + choice([1, -1]))
    ...
    answer_2_false = possible_shape(len(the_list)) if _2 == 1                    else possible_shape(len(the_list) + choice([1, -1]))
...
def quest_5(the_list):
    ...
    if _5_dimension == 1:
        idx = idx[0]
        answer = 'array completo' if idx == ':' else 'array constituido somente por letras'               if int(idx) % 2 == 0 else str('array constituido somente por ' + pt_numeros)
        return pt_e + ' ' + answer
