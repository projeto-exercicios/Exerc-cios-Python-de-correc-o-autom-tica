...
def make_transformations():
    ...
    change_token_all_occurrences('m',"<b><font color=red><i>" +  m+ "</font></i></b>")
    change_all_occurrences('10',"<b><font color=red><i>" +  str(_10)+ "</font></i></b>")
    change_all_occurrences('15',"<b><font color=red><i>" +  str(_15)+ "</font></i></b>")
    ...
    change_all_occurrences(r'\verb+b+',"<b><font color=red><i>" +  r'\verb+' + str(_1) + '+'+ "</font></i></b>")
...
def make_transformations_on_results(program):
    ...
    change_all_occurrences(r'\verb+1+',"<b><font color=red><i>" +  r'\verb+' + letter + '+'+ "</font></i></b>")
    word, equasion = choice_to_do()
    change_all_occurrences(r'\verb+2+',"<b><font color=red><i>" +  r'\verb+' + word + '+'+ "</font></i></b>")
    letter_2, max_occur = max_num_occurences(the_list)
    change_all_occurrences(r'\verb+4+',"<b><font color=red><i>" +  r'\verb+' + letter_2 + '+'+ "</font></i></b>")
